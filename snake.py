...
# Colors
text_color = (0, 0, 0)
base_color = (95, 158, 160)
snake_color = (15, 255, 80)
food_color = (255,0,0)
...
while not exit_game:
    ...
    if not started:
        ...
        #Play Area
        pygame.draw.rect(window, text_color, [play_x, play_y, play_width, play_height],3)
        
        # Vertical Lines
        for y in range(play_x, play_x+play_width, cell_size):
            pygame.draw.line(window, text_color, (y, play_y), (y, play_y+play_height))
        # Horizontal Lines
        for x in range(play_y, play_y+play_height, cell_size):
            pygame.draw.line(window, text_color, (play_x ,x), (play_x+play_width, x))
        # Snake
